        ...
        <ScrollView>
            ...
            <List.Item
                ...
                <List.Item
                    ...
                    right={(props) =><Counter storageKey="TURNS_RIGHT_APPROACH_SPEED"/>}
                    />
                    <List.Item
                    title="Signal"
                    left={(props) => 
            ...
            <List.Item
                ...
                <List.Item
                    ...
                    left={(props) => 
                        <Avatar.Image {...props}  source={require("../../assets/speed.png")}/>}
                    right={(props) =><Counter storageKey="TURNS_RIGHT_STOP_SPEED"/>}
                    />
                <List.Item
                    title="Visual Search"
                    left={(props) => 
            ...
            <List.Item 
                ...
                <List.Item 
                    ...
                    right={(props) =><Counter storageKey="TURNS_RIGHT_SMOOTHNESS"/>}
