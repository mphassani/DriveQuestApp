            ...
            {/* <View style={{ flexDirection:"row", justifyContent: "space-around" }}>
                ...
                <SectionTitle name="Freeway Lane Change Left" />
                    ...
                    <CounterRow
                        ...
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_DRIVER_SIDE_MIRROR"
                    />
                    <CounterRow
                        title="Rear View Mirror"
                        icon={require("../../assets/rearViewMirror.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_REAR_VIEW_MIRROR"
                    />
                    <CounterRow
                        title="Passenger Side Mirror"
                        icon={require("../../assets/passengerSideMirror.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_PASSENGER_SIDE_MIRROR"
                    />
                    <CounterRow
                        title="Left Shoulder"
                        icon={require("../../assets/leftShoulder.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_LEFT_SHOULDER"
                    />
                    <CounterRow
                        title="Right Shoulder"
                        icon={require("../../assets/rightShoulder.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_RIGHT_SHOULDER"
                    />
                    <CounterRow
                        title="Signal"
                        icon={require("../../assets/Signal.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_SIGNAL"
                    />
                    <CounterRow
                        title="Speed"
                        icon={require("../../assets/speed.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_SPEED"
                    />
                    <CounterRow
                        title="Spacing"
                        icon={require("../../assets/spacing.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_SPACING"
                    />
                    <CounterRow
                        title="Steering Control"
                        icon={require("../../assets/SteeringControl.png")}
                        storageKey="FREEWAY_LANE_CHANGE_LEFT_STEERING_CONTROL"
                    />
